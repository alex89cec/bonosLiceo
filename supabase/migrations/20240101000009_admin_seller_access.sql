-- ============================================================
-- Migration 9: Allow admins to act as sellers
-- - Auto-generate seller_code for admin profiles without one
-- - Update reserve_ticket RPC to accept admin role
-- - Admins skip campaign_sellers check (can sell any campaign)
-- ============================================================

-- ============================================================
-- 1. AUTO-GENERATE seller_code FOR ADMIN PROFILES
-- ============================================================
update public.profiles
set seller_code = 'ADM-' || upper(substring(id::text, 1, 6))
where role = 'admin' and seller_code is null;

-- ============================================================
-- 2. RECREATE reserve_ticket: accept admin role, skip assignment check for admins
-- ============================================================
